...
#define STRING_CONFIG_H_AUTHOR "(Spydyr, CoreXY)" // Who made the changes.
...
#define PID_K1 0.95      // Smoothing factor within any PID loop
  ...
  #else
    #define DEFAULT_Kp  16.2264
    #define DEFAULT_Ki   1.0325
    #define DEFAULT_Kd  63.7495
  #endif
#endif // PIDTEMP
...
#define MAX_BED_POWER 255 // limits duty cycle to bed; 255=full current
  ...
  #define DEFAULT_bedKp 107.8641
  #define DEFAULT_bedKi 19.4965
  #define DEFAULT_bedKd 397.8389
 ...
 *                                      X, Y, Z, E0 [, E1[, E2...]]
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 80.003, 80.131, 800, 410 }
 ...
 *                                      X, Y, Z, E0 [, E1[, E2...]]
 */
#define DEFAULT_MAX_FEEDRATE          { 1000, 1000, 45, 100 }
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { 0, -43.6, -1.3 }
